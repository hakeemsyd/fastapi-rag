...
class VectorRepository:
    ...
    async def create(
            ...
            logger.debug(
                    f"Creating new vector with ID {response.count}"
    ...
    async def search(
        ...
        logger.debug(f"Searching for relevent items in the {collection_name} collection")
        ...
        logger.debug(f"Search results: {response.points}")
